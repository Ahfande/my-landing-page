    ...
    <>
        ...
        <div id="home" className="Content1Container">
          <div className="TextContainer">
            ...
            <h4 className="TitleSkils">
              Fullstack IoT Developer | Web Developer
            </h4>
      ...
      <section id="about" className="Content2Container">
        ...
        <div className="TextAboutContainer">
          ...
          <p>
            I am a Full-Stack Web Developer with experience building responsive,
            scalable, and user-focused web applications.<br></br> I specialize in
            React/Vanilla for frontend development and backend services. <br></br><br></br>
            I have developed real-time web dashboards, authentication systems, and
            database-driven applications, including web platforms integrated
            with IoT devices. I focus on writing clean, maintainable code and
      ...
      <section id="project">
        ...
        <div className="ProjectContainer">
          ...
          <div className="ProjectBox">
            ...
            <div className="ProjectInfo">
              <h3 className="ProjectName">Kotak Segitiga</h3>
              <div className="JobAndBtn">
                <p className="JobProject">Website | Fullstack</p>
                <button
                  className="BtnPreview"
                  onClick={() => handlePreviewClick("KotakSegitiga")}
                >
                  Preview
                </button>
              </div>
          ...
          <div className="ProjectBox">
            ...
            <div className="ProjectInfo">
              <h3 className="ProjectName">LMS (User/Student)</h3>
              <div className="JobAndBtn">
                <p className="JobProject">Website | Fullstack</p>
                <button
                  className="BtnPreview"
                  onClick={() => handlePreviewClick("LMS(siswa)")}
                >
                  Preview
                </button>
              </div>
          ...
          <div className="ProjectBox">
            ...
            <div className="ProjectInfo">
              <h3 className="ProjectName">LMS (Admin/Teacher)</h3>
              <div className="JobAndBtn">
                <p className="JobProject">Website | Fullstack</p>
                <button
                  className="BtnPreview"
                  onClick={() => handlePreviewClick("LMS(Guru)")}
                >
                  Preview
                </button>
              </div>
      ...
      <footer className="Footer">
        <div className="FooterContent">
          <div className="FooterSection">
            ...
            <p>
              Dedicated to creating innovative technology solutions that make a
              difference.
            </p>
          </div>
